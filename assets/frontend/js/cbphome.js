$(document).ready(function () {
    ...
    */
    ...
    $(".data-refresh-reset").on('click', function (event){
        $('#js-grid-lightbox-gallery').cubeportfolio('destroy');
       window.open("https://www.panomatics.com/home/", "_self");
    });
...
//        event.stopPropagation;
        ...
        var next = start * parseInt(_limit);
            ...
            $.ajax({
            type : "POST",
            url : "https://www.panomatics.com/home/loadMore",
            ...
            $.ajax({
            type : "POST",
            url : "https://www.panomatics.com/home/loadMoreClient",
    ...
    // BEST SCROLLER: https://stackoverflow.com/a/15382570

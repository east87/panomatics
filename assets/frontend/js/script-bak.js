...
const url = 'https://localhost/panom/assets/json/CountryCodes.json';
			...
			'<div id="pop-up-box">' +
				'<div id="pop-up-content">' +
					'<div id="login-content">' +
						...
						'<form id="form-login" action="http://panomatics.com/signin" method="POST" row="'+id+'">' +
...
function closeLoginSuccess(detail) {
	...
	document.getElementById('pop-up-wrapper').innerHTML = '';
         window.open("http://panomatics.com/project/detail/"+detail, "_self");
...
function openPopupRegister() {
	...
	document.getElementById('pop-up-wrapper').innerHTML =
			...
			'<div id="pop-up-box">' +
				...
				'<div id="pop-up-content">' +
					...
					'<div id="register-content">' +
						...
						'<form id="form-register" action="http://panomatics.com/register" method="POST">' +
		...
		'<div id="pop-up-footer">' +
			'<a href="http://panomatics.com/contact" target ="_blank">OFFICES AND LOCATIONS</a>' +
			'<span>|</span>' +
			'<a href="http://panomatics.com/contact" target ="_blank">CONTACT</a>' +
			'<span>|</span>' +
			'<a href="http://panomatics.com/terms" target ="_blank">TERMS & CONDITIONS</a>' +
			...
			'<div id="pop-up-box">' +
				'<div id="pop-up-content">' +
					'<div id="forget-content">' +
						...
						'<form id="form-forget" action="http://panomatics.com/forget" method="POST">' +
							'<input id="email" name="email" type="text" placeholder="EMAIL">' +
...
function closeForgetSuccess() {
	...
	document.getElementById('pop-up-wrapper').innerHTML = '';
         window.open("http://panomatics.com/", "_self");
...
function forgetError() {
	...
	document.getElementById('forget-content').innerHTML =
		...
		'</div>' +
		'<h4 id="form-title">ACCESS DENIED</h4>' +
		'<p class="error-text-login">There was a problem with your login, please check email & password and <a href="#" onClick="openPopupLogin()">try again </a>. <br>&nbsp; If you&rsquo;ve forgotten your password, <a href="#" onClick="openPopupForget()">click here</a></p>';
}

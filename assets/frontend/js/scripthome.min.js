			...
			'<div id="pop-up-box">' +
				'<div id="pop-up-content">' +
					'<div id="login-content">' +
						...
						'<form id="form-login" action="https://localhost/panom/signin" method="POST">' +
			...
			'<div id="pop-up-box">' +
				...
				'<div id="pop-up-content">' +
					...
					'<div id="register-content">' +
						...
						'<form id="form-register" action="https://localhost/panom/register" method="POST">' +
...
function registerError() {
	...
	document.getElementById('register-content').innerHTML =
		...
		'<p class="error-text">Something went wrong whilst processing your data. Please <a href="#" <a onClick="openPopupRegister()">review</a> your input and try again. Thank you!</p>';
}

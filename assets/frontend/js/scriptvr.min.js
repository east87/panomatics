...
(function (root, factory) {
    ...
    mdl.mdlForm = function (mdlName) {
        ...
        function _submit(event) {
          ...
          //alert(formId);
            submitContactForm(frmAct,formId);
...
function submitContactForm(frmAct,formId)
    {
        var urlF = frmAct;
        var formId =formId;
			...
			'<div id="pop-up-box">' +
				'<div id="pop-up-content">' +
					'<div id="login-content">' +
						...
						'<div id="logo-color">' +
							'<img src="http://panomatics.com/assets/images/panomaticsvr-logo.png" alt="Panomatics Logo" />' +
						'</div>' +
						'<h4 id="form-title">WELCOME TO PANOMATICS VIRTUAL TOURS!</h4>' +
						'<form id="form-login" action="http://panomatics.com/signin" method="POST">' +
...
function loginSuccess() {
	...
	document.getElementById('login-content').innerHTML =
		'<button id="button-close-login" onClick="closeLoginSuccess()">X</button>' +
		'<div id="logo-color">' +
			'<img src="http://panomatics.com/assets/images/panomaticsvr-logo.png" alt="Panomatics Logo" />' +
		'</div>' +
...
function loginError() {
	...
	document.getElementById('login-content').innerHTML =
		...
		'<p class="error-text-login">There was a problem with your login, please check email & password and try again <a href="#" onClick="openPopupLogin()">here</a>.</p>';
}
...
function openPopupRegister() {
	...
	document.getElementById('pop-up-wrapper').innerHTML =
		'<div id="header-pop-up">' +
			'<img src="http://panomatics.com/assets/images/panomaticsvr-logowhite.png" />' +
		'</div>' +
		'<div id="pop-up-col">' +
			'<div id="pop-up-box">' +
				'<div id="register-image-banner">' +
					'<img src="http://panomatics.com/assets/images/vr-bg.jpeg" alt="" />' +
				'</div>' +
				'<div id="pop-up-content">' +
					'<div id="logo-color">' +
						'<img src="http://panomatics.com/assets/images/panomaticsvr-logo.png" alt="Panomatics Logo" />' +
		...
		'<div id="pop-up-footer">' +
			...
			'<span>|</span>' +
			'<a href="//panomatics.com/terms">TERMS & CONDITIONS</a>' +
...
function registerError() {
	...
	document.getElementById('register-content').innerHTML =
		...
		'<p class="error-text">Something went wrong whilst processing your data, because your email has been registered. Please <a href="#" <a onClick="openPopupRegister()">review</a> your input and try again. Thank you!</p>';
}

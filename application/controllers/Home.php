...
class Home extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->data["totalClient"]  = $totalClient;
    ...
    public function index()
    {
        ...
        $order_limit .= " limit  0, 12 ";
        $order_limitbanner = '';
        $order_limitbanner .= "  order by a.row_order DESC";
        ...
        if ($_POST) {
            ...
            if ($countProduct > 0) {
                ...
                foreach ($ListProduct as $pr) {
                    ...
                    $result .= '<div class="col-25 animated fadeIn delay-'.$i.'s" ' . $onclick . ' >';
                    ...
                    $result .= '<a href="' . $ref . '" class="hotel-info" data_href="'.$getref.'"  id="data_link'.$pr['row_id'].'">';

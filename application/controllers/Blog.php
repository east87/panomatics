...
class Blog extends CI_Controller {
...

	{
		...
		$this->data['controller'] = $module_name;              
                ...
                $whereBlog .= "WHERE  a.row_active_status=1 and a.row_parent=0 and a.module_id = ".$_SESSION['module_id'];
	 ...
	 function index()
	{
                ...
                $whereBlog1 = '';
                $whereBlog1 .= "WHERE  a.row_active_status=1 and a.row_parent=0 and a.module_id = ".$_SESSION['module_id'];

...
class Agent extends CI_Controller
{
    ...
    function sendmailConf($name, $email, $passgenerate)
    {
		...
		'smtp_user' => 'panomaticsvr',
                'smtp_pass' => 'P4n0m4V_r',
                'smtp_port' => 587,
                'crlf' => "\r\n",
                'newline' => "\r\n"
        ));
        $this->email->from('panomatics.vr@gmail.com', 'Password Confirmation');// change it to yours

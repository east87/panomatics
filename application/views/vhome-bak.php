         ...
         <div id="image-wrapper">
            <div id="main-image-banner" class="bg-load lazy-load">
               <div id="container">
                   ...
                   <iframe src="" class="lazy-load" src-url="https://www.panomatics.com/nextgen/maldives/niyama/index-web1.html?startscene=0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                </div>
               </div>
            </div>
         </div>
         ...
         <div id="content-select-wrapper">
          ...
          <div class="container" id="load-more-container">
            <div style="margin:0 auto; width:15vw; border:0px solid black; text-align:center; ">
               <a href="" id="load-more" data-limit="4" data-curpage="1" data-total="<?=$totalProduct?>" data-pages="products=ANY|location=ANY|business=ANY" style="display:block; padding:15px 20px; font: 400 12px/1.38 'novecento_sans_widemedium'; text-align: center;  letter-spacing: 4px; color: rgb(0, 0, 0);">
               LOAD MORE
               <br>
               <br>
               [1/<?=$totalProduct?>]

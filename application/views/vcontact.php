            ...
            <script  type="text/javascript" charset="UTF-8" >
              ...
              var marker = new H.map.Marker(coordinate, { icon: icon });
               ...
               function addInfoBubble(map) {
                 ...
                 group.addEventListener('tap', function (evt) {
                   var bubble =  new H.ui.InfoBubble(evt.target.getPosition(), {
                     ...
                     // remove another bubble
                   ui.getBubbles().forEach(bub => ui.removeBubble(bub));
                    // add new bubble
                   ui.addBubble(bubble);
                 }, false);
                <?php foreach ($ListContact as $lp) {?>
                 addMarkerToGroup(group, {lat:<?=contentValue($lp, 'latitude');?>, lng:<?=contentValue($lp, 'longitude');?>},
                  '<div>\n\
                                 <div class="imgmap">\n\
                                 <img class="" src="<?=contentValue($lp, 'images');?>" width="400" height="150">\n\
                                 </div>\n\
                                 <div>\n\
                                 <p class="addr"><b><?=contentValue($lp, 'address');?></b></p>\n\
                                 </div>\n\
                                 </div>');
                 <?php  } ?>
               }
               ...
               var platform = new H.service.Platform({
                app_id: 'RfZVhPYI1Ivr3Oj9xYE4',
                 app_code: 'jn6uN5NGbd8sJ0pHdHTAqA',
                 useHTTPS: true
               });
               ...
               var map = new H.Map(document.getElementById('map'),
                 ...
                 center: {lat:29.115150, lng:94.765202},
                 zoom: 2,

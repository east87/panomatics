    ...
    <meta name="msvalidate.01" content="FA0D073B12840F6BD580F94FF4C4A733" />
     ...
     <?php include 'include/analytics.php';?>
      ...
      <link rel="stylesheet" type="text/css" href="<?= FRONTEND_BASE_URL; ?>/css/cubeportfolio.css">
       <link rel="stylesheet" type="text/css" href="<?= FRONTEND_BASE_URL; ?>/css/animate.min.css">
      <noscript>
    ...
    <?php include 'include/tagmanager.php';?>
      ...
      <div id="container">
         ...
         <div id="image-wrapper">
          ...
          <?php  } } ?>
         <div id="socmed-wrapper" style="display:none;">
            ...
            <div class="cbp-l-filters-dropdownWrap">
               ...
               <div class="cbp-l-filters-dropdownList">
                ...
                <?php $x= 0; foreach ($label['options'] as $opt) { 
                  ...
                  <div id="filter-<?=generateIdTxt($opt['options_title'])?>" data-filter=".<?=generateIdTxt($opt['options_title'])?>" data-href="#" data-type="<?=$label['label_name']?>" data-value="<?=generateIdTxt($opt['options_title'])?>" class="cbp-filter-item data-refresh <?=$addclass;?>"><?=$opt['options_title']?><?=$counts;?></div>
                  <?php   } ?>
               </div>
            </div>
         </div>
      ...
      <div id="page-content">
         <div id="content-select-wrapper">
               ...
               <div id="photo-ocean-club" class="gallery-subcategory current">
                  <?php
                     ...
                     foreach($ListProduct as $pr){
                             $i++;
                       if ($pr['row_alias'] !=''){
                          $getref =BASE_URL.'/'.$pr['row_alias'];  
                        }
                        else {
                          $getref = BASE_URL.'/project/detail/'.$pr['row_id']; 
                        }       
                  ...
                  <?php $visibility = contentValue($pr, 'visibility');
                     ...
                     ?>
                  <div  class="col-25  fadeIn delay-<?=$i;?>s" <?=$onclick?> >
                     ...
                     <a href="<?=$ref;?>" class="hotel-info" data_href="<?=$getref;?>" id="data_link<?=$pr['row_id']?>">
          ...
          <div class="container" id="load-more-container">
            <div style="margin:0 auto; width:15vw; border:0px solid black; text-align:center;">
               <a id="load-more" data-limit="4" data-curpage="3" data-total="<?=$totalProduct?>" data-pages="products=ANY|location=ANY|business=ANY" style="display:block; padding:15px 20px; font: 400 12px/1.38 'novecento_sans_widemedium'; text-align: center;  letter-spacing: 4px; color: rgb(0, 0, 0);">
               LOAD MORE
               <br>
               <br>
               [3/<?=$totalProduct?>]
         ...
         <div id="our-client">
          ...
          <input id="count_client" type="hidden" value="<?= $totalClient?>" />
      </div>

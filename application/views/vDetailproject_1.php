        ...
        ?>
         <?php  $type = contentValue($content, 'product');?>
            <?php if ($type == 'Still Images') { 
                foreach($child as $pr){ ?>
            <img src="<?=contentValue($pr, 'slide_image');?>" class="gallery-thumb bg-load img-async" src-url="">
          <?php } ?> 
         ...
         <?php } 
          ...
          <?php } ?> 
            <?php } else { ?>
            <iframe class="lazy-load"  allow="autoplay; encrypted-media" allowfullscreen="" frameborder="0" height="400" src="<?= html_entity_decode(contentValue($content, 'iframe'));?>" width="560" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>      
            <?php } ?> 
       </div>
         ...
         <div id="product-thumbs-wrapper">
            ...
            <div class="col-33">
               <a href="#" class="product-thumb-box">
                  ...
                  <div class="product-thumb-img bg-load lazy-load">
                     <p><?= strtoupper(html_entity_decode(contentValue($content, 'technical_specs')));?></p>
                  </div>
               </a>
            </div>
            <div class="col-33">

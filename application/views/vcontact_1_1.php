            ...
            <script  type="text/javascript">
               function addMarkersToMap(map) {
                <?php foreach ($ListContact as $lp) {?>
                 var <?= generateNameLabel(contentValue($lp, 'title'));?> = new H.map.Marker({lat:<?=contentValue($lp, 'latitude');?>, lng:<?=contentValue($lp, 'longitude');?>});
                 map.addObject(<?= generateNameLabel(contentValue($lp, 'title'));?>);
                 <?php  } ?>
               }

                  ...
                  <form name="form1" action="<?php echo BASE_URL_BACKEND.'/'.$controller.'/doAdd'; ?>" method="post" role="form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator">
                     ...
                     <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                           ...
                           <div class="col-lg-6">
                              <input name="privatestitle" type="text" class="form-control m-input" placeholder="privates Title" value="<?php if(!empty($privatestitle)){echo $privatestitle;} ?>">
                        ...
                        <div class="form-group m-form__group row">
                           ...
                           <div class="col-lg-6">
                              ...
                              <input type="text" name="privatesimageurl" readonly="readonly" id="imageurl" class="form-control" value="<?php if(!empty($privatesimageurl)){echo $privatesimageurl;} ?>">
                        ...
                        <div class="form-group m-form__group row">
                           ...
                           <div class="col-lg-10">
                            <textarea name="privatesdesc" type="text" class="form-control m-input ckeditor" placeholder="section" value=""><?php if(!empty($privatesdesc)){echo $privatesdesc;} ?> </textarea>                                                               
                           </div>
                        </div>
                       <div class="form-group m-form__group row">
                           <label class="col-lg-2 col-form-label">
                           ...
                           <div class="col-lg-6">
                              <input name="privatesurla" type="text" class="form-control m-input" placeholder="privates Url" value="<?php if(!empty($privatesurla)){echo $privatesurla;} ?>">
                              <span class="m-form__help">
                              CALL US Url
                              </span>
                           </div>
                        ...
                        <div class="form-group m-form__group row">
                          ...
                          Contact Url:
                           ...
                           <div class="col-lg-6">
                              <input name="privatesurlb" type="text" class="form-control m-input" placeholder="privates Url" value="<?php if(!empty($privatesurlb)){echo $privatesurlb;} ?>">
                              <span class="m-form__help">
                              Contact Url
                              </span>
                           </div>

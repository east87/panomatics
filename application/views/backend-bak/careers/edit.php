      ...
      <div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
         ...
         <div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="m-content">
               <div class="m-portlet">
                  <!--begin::Form-->
                  <form name="form1" action="<?php echo BASE_URL_BACKEND.'/'.$controller.'/doEdit/'.$rsCareers[0]['careers_id']; ?>" method="post" role="form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator">
                     <?php if(isset($error)){ ?>
                     ...
                     <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                          ...
                          Careers Title:
                           ...
                           <div class="col-lg-6">
                              <input name="careerstitle" type="text" class="form-control m-input" placeholder="careers Title" value="<?php echo $rsCareers[0]['careers_title']; ?>">
                               <input name="careerstitleOld" type="hidden" value="<?php echo $rsCareers[0]['careers_title']; ?>">
                        ...
                        <div class="form-group m-form__group row">
                                <label class="col-lg-2 col-form-label">
                                    ...
                                    <?php
                                        $banner_image_thumbs = BASE_URL.str_replace('/admin/images','/admin/.thumbs/images',$rsCareers[0]['careers_image']);
                                        $banner_image = BASE_URL.$rsCareers[0]['careers_image'];
                                        ?>
                                    <div class="col-lg-8">
                                          ...
                                          <input type="text" name="careersimageurl" readonly="readonly" id="imageurl" class="form-control" value="<?php echo $banner_image ?>">
                        ...
                        <div class="form-group m-form__group row">
                           ...
                           <div class="col-lg-10">
                               <textarea name="careersdesc" type="text" class="form-control m-input ckeditor" placeholder="section" value=""><?php echo $rsCareers[0]['careers_desc']; ?> </textarea>                          
                           </div>
                        </div>

      ...
      <div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
         ...
         <div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="m-content">
               <div class="m-portlet">
                  <!--begin::Form-->
                  <form name="form1" action="<?php echo BASE_URL_BACKEND.'/'.$controller.'/doEdit/'.$rsPrivacy[0]['privacy_id']; ?>" method="post" role="form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator">
                     <?php if(isset($error)){ ?>
                     ...
                     <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                          ...
                          Privacy Title:
                           ...
                           <div class="col-lg-6">
                              <input name="privacytitle" type="text" class="form-control m-input" placeholder="privacy Title" value="<?php echo $rsPrivacy[0]['privacy_title']; ?>">
                               <input name="privacytitleOld" type="hidden" value="<?php echo $rsPrivacy[0]['privacy_title']; ?>">
                              <span class="m-form__help">
                              Please enter Privacy title
                              </span>
                           </div>
                        </div>
                        ...
                        <div class="form-group m-form__group row">
                                <label class="col-lg-2 col-form-label">
                                    ...
                                    <?php
                                        $banner_image_thumbs = BASE_URL.str_replace('/admin/images','/admin/.thumbs/images',$rsPrivacy[0]['privacy_image']);
                                        $banner_image = BASE_URL.$rsPrivacy[0]['privacy_image'];
                                        ?>
                                    <div class="col-lg-8">
                                          ...
                                          <input type="text" name="privacyimageurl" readonly="readonly" id="imageurl" class="form-control" value="<?php echo $banner_image ?>">
                        ...
                        <div class="form-group m-form__group row">
                           ...
                           <div class="col-lg-10">
                               <textarea name="privacydesc" type="text" class="form-control m-input ckeditor" placeholder="section" value=""><?php echo $rsPrivacy[0]['privacy_desc']; ?> </textarea>                          
                           </div>
                        </div>
                           ...
                           <div class="m-form__actions m-form__actions--solid">
                              <div class="row">
                                 ...
                                 <div class="col-lg-6">
                                    ...
                                    <input name="cancel" class="btn btn-danger btn-sm" type="button" value="Cancel" onClick="location.href='<?php echo BASE_URL_BACKEND.'/privacy'; ?>'">                                                      
                                 </div>
                              </div>
                           </div>
                        </div>

                  ...
                  <form name="form1" action="<?php echo BASE_URL_BACKEND.'/'.$controller.'/doAdd'; ?>" method="post" role="form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator">
                     ...
                     <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                           ...
                           <div class="col-lg-6">
                              <input name="privacytitle" type="text" class="form-control m-input" placeholder="privacy Title" value="<?php if(!empty($privacytitle)){echo $privacytitle;} ?>">
                        ...
                        <div class="form-group m-form__group row">
                           ...
                           <div class="col-lg-6">
                              ...
                              <input type="text" name="privacyimageurl" readonly="readonly" id="imageurl" class="form-control" value="<?php if(!empty($privacyimageurl)){echo $privacyimageurl;} ?>">
                        ...
                        <div class="form-group m-form__group row">
                           ...
                           <div class="col-lg-10">
                            <textarea name="privacydesc" type="text" class="form-control m-input ckeditor" placeholder="section" value=""><?php if(!empty($privacydesc)){echo $privacydesc;} ?> </textarea>                                                               
                           </div>
                        </div>

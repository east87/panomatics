                  ...
                  <form name="form1" action="<?php echo BASE_URL_BACKEND.'/category/doAdd'; ?>" method="post" class="form-horizontal" role="form">
                     <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row">
                           ...
                           <div class="col-lg-6">
                              <input name="categorytitle" type="text" class="form-control m-input" placeholder="Category Title" value="<?php if(!empty($categorytitle)){echo $categorytitle;} ?>">
                        ...
                        <div class="form-group m-form__group row">
                           ...
                           <div class="col-lg-6">
                              <select class="form-control m-input" name="categoryparent" id="categoryparent">

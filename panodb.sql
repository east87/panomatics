...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 19, 2018 at 09:38 PM
...
(234, 0, 51, 32, '/assets/file_upload/admin/images/img-latest-3.jpg'),
(223, 0, 50, 38, 'dasdasdasdas'),
(224, 0, 50, 39, '08/13/2018'),
(232, 0, 51, 41, '47'),
(233, 0, 51, 31, '/assets/file_upload/admin/images/img-logo-trump.jpg'),
(231, 0, 51, 37, '45'),
(229, 0, 51, 30, '29'),
(230, 0, 51, 36, '43'),
(228, 0, 51, 29, '19'),
...
(235, 0, 51, 33, 'dadasdasdsa'),
(236, 0, 51, 34, 'ddsadadsa'),
(237, 0, 51, 35, '42'),
(238, 0, 52, 27, 'dadasdsa'),
(239, 0, 52, 28, '13'),
(240, 0, 52, 29, '27'),
(241, 0, 52, 30, '36'),
(242, 0, 52, 36, '44'),
(243, 0, 52, 37, '45'),
(244, 0, 52, 41, '48'),
(245, 0, 52, 31, '/assets/file_upload/admin/images/img-logo-shangrila.jpg'),
(246, 0, 52, 32, '/assets/file_upload/admin/images/img-latest-1.jpg'),
(247, 0, 52, 33, 'dasdsada&amp;nbsp;'),
(248, 0, 52, 34, ''),
(249, 0, 52, 35, '41'),
...
(37, 0, 100, 'Still Photography', 'still_photography', 6, 1, 6, 1),
(36, 0, 100, 'Aerial', 'aerial_tour', 6, 1, 5, 1),
(35, 0, 100, 'visibility', 'visibility', 6, 1, 12, 1),
(28, 0, 100, 'Video', 'option_video', 6, 1, 2, 1),
...
(27, 0, 100, 'Title', 'product_title', 1, 1, 1, 1),
(29, 0, 100, 'Country', 'product_country', 6, 1, 3, 1),
(30, 0, 100, 'Panorama Tour', 'panorama_tour', 6, 1, 4, 1),
(31, 0, 100, 'icon', 'client_icon', 3, 1, 8, 1),
(32, 0, 100, 'Image', 'product_image', 3, 1, 9, 1),
(33, 0, 100, 'Desc', 'desc', 2, 1, 10, 1),
(34, 0, 100, 'Url', 'url_link', 1, 1, 11, 1),
(41, 0, 100, 'Other Services', 'other_services', 6, 1, 7, 1),
...
(51, 0, 100, 1, '2018-08-14 17:07:56', 1, '2018-08-20 02:18:21', 1),
(52, 0, 100, 1, '2018-08-19 03:10:58', 1, '2018-08-20 02:18:42', 1),
...
--
ALTER TABLE `tbl_content`
  MODIFY `content_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=257;
...
--
ALTER TABLE `tbl_label`
  MODIFY `label_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `tbl_log_cms`
  MODIFY `log_id_cms` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=702;
...
--
ALTER TABLE `tbl_row`
  MODIFY `row_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
